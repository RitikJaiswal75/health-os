...
cd health-os
npm install
npm run ingest-cdci   # build bundled India catalog (assets/catalog/india.db)
```
...
| Catalog | Bundled India CDCI SQLite + RxTerms + NIH DSLD |
...
assets/catalog/       Bundled india.db (generated by ingest-cdci)
